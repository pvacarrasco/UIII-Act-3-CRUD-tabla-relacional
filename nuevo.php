...
$sentencia = $base_de_datos->prepare("INSERT INTO `productos`(`marca`, `color`, `tipo_armazon`, `diseno`, `aumento`, `costo`, `disponible`)  VALUES (?, ?, ?, ?, ?, ?, ?);");
$resultado = $sentencia->execute([ $marca, $color, $tipo_armazon, $diseno, $aumento, $costo, $disponible]);
