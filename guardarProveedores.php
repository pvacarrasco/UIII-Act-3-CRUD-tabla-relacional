...
$sentencia = $base_de_datos->prepare("UPDATE proveedores SET id_Proveedor = ?, nombre = ?, correo = ?, usuario = ?, telefono = ?, domicilio = ?, cp = ?, ciudad = ? WHERE id = ?;");
$resultado = $sentencia->execute([$id_Proveedor, $nombre, $correo, $usuario, $telefono, $domicilio, $cp, $ciudad, $id]);
